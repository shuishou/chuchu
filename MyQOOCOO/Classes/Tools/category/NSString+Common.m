...
//                urlStr = [NSString stringWithFormat:@"http://coding-net-avatar.qiniudn.com/%@?imageMogr2/auto-orient/thumbnail/!%.0f", imageName, width];
//            }else{
//                urlStr = [NSString stringWithFormat:@"%@%@", kNetPath_Code_Base, self];
//            }
//        }else{
...
//                        urlStr = [urlStr stringByAppendingString:[NSString stringWithFormat:@"/thumbnail/!%.0f/format/png", width]];
//                    }else{
//                        urlStr = [urlStr stringByAppendingString:[NSString stringWithFormat:@"?imageMogr2/auto-orient/thumbnail/!%.0f/format/png", width]];
//                    }
//                }else{
//                    if ([urlStr rangeOfString:@"?"].location != NSNotFound) {
//                        urlStr = [urlStr stringByAppendingString:[NSString stringWithFormat:@"/thumbnail/!%.0f", width]];
//                    }else{
//                        urlStr = [urlStr stringByAppendingString:[NSString stringWithFormat:@"?imageMogr2/auto-orient/thumbnail/!%.0f", width]];
//                    }
//                }
