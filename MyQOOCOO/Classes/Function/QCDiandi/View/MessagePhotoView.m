...
- (void)setup{
    ...
    lblNum = [[UILabel alloc]initWithFrame:CGRectMake(40, CGRectGetHeight(self.frame)-40, 120, 30)];
...
//    根据项目需求，发送一个通知，退键盘
    [[NSNotificationCenter defaultCenter]postNotificationName:kMessagePhotoViewAddBtnClickNotification object:nil];
