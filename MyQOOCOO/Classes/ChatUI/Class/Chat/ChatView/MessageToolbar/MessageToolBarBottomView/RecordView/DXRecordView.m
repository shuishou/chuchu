...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _recordAnimationView = [[UIImageView alloc] initWithFrame:CGRectMake(25, 0, self.bounds.size.width - 50, self.bounds.size.height - 40)];
        _recordAnimationView.image = [UIImage imageNamed:@"HFrecord_animate_01"];
        _recordAnimationView.layer.masksToBounds = YES;
...
{
    _textLabel.text = NSLocalizedString(@"手指松开,取消发送", @"loosen the fingers, to cancel sending");
...
-(void)setVoiceImage {
    ...
    if (0 < voiceSound <= 0.05) {
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_01"]];
    }else if (0.05<voiceSound<=0.10) {
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_02"]];
    }else if (0.10<voiceSound<=0.15) {
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_03"]];
    }else if (0.15<voiceSound<=0.20) {
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_04"]];
    }else if (0.20<voiceSound<=0.25) {
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_05"]];
    }else if (0.25<voiceSound<=0.30) {
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_06"]];
    }else if (0.30<voiceSound<=0.35) {
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_07"]];
    }else if (0.35<voiceSound<=0.40) {
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_08"]];
    }else if (0.40<voiceSound<=0.45) {
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_09"]];
    }else if (0.45<voiceSound<=0.50) {
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_010"]];
    }else if (0.50<voiceSound<=0.55) {
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_011"]];
    }else if (0.55<voiceSound<=0.60) {
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_012"]];
    }else if (0.60<voiceSound<=0.65) {
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_013"]];
    }else{
        [_recordAnimationView setImage:[UIImage imageNamed:@"HFrecord_animate_014"]];
    }
