...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _recevierAnimationImages = [[NSMutableArray alloc] initWithObjects: [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_01], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_02], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_03], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_04], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_05], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_06], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_07], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_08], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_09], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_10], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_11], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_12], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_12], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_13], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_14], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_15], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_16], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_17], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_18], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_19], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_20], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_21], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_22], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_23], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_24], [UIImage imageNamed:RECEIVER_ANIMATION_IMAGEVIEW_IMAGE_25], nil];
    }
    return self;
}
...
-(CGSize)sizeThatFits:(CGSize)size
{
    ...
    if (_animationImageView.isAnimating) {
        return CGSizeMake(WIDTH(_animationImageView)+50, height);
    }
    else
    {
...
-(void)stopAudioAnimation
{
    ...
    else
    {
        ...
        frame.origin.x = BUBBLE_ARROW_WIDTH + BUBBLE_VIEW_PADDING;
        frame.origin.y = self.frame.size.height / 2 - frame.size.height / 2;
        frame.size.width = ANIMATION_IMAGEVIEW_SIZE;
        _animationImageView.frame = frame;
    }
}
