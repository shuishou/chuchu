...
-(void)layoutSubviews
{
    ...
    if ([self.messageModel.content containsString:@"send_content_from_card_to_show"]){
        _bubbleView.frame = CGRectMake(bubbleFrame.origin.x, bubbleFrame.origin.y,bubbleFrame.size.width , 160);
...
- (EMChatBaseBubbleView *)bubbleViewForMessageModel:(MessageModel *)messageModel
{
    switch (messageModel.type) {
        ...
        {
            if ([messageModel.content containsString:@"send_content_from_card_to_show"]) {
                EMChatBusinessCardBubbleView*CBCBV=[[EMChatBusinessCardBubbleView alloc] initWithFrame:CGRectMake(100, 100, 100, 100)];
    ...
    switch (messageModel.type) {
        case eMessageBodyType_Text:
        {
            ...
            if ([messageModel.content containsString:@"send_content_from_card_to_show"]) {
                ...
                return [EMChatBusinessCardBubbleView heightForBubbleWithObject:messageModel];
            }
...
//        if ([view isKindOfClass: [EMChatBusinessCardBubbleView class]]) {
//            [self routerEventWithName:@"pushtoUser" userInfo:@{KMESSAGEKEY:self.messageModel.content}];
//        }
//    }
//}
