...
//#warning toView如果写nil 代表转换成窗口坐标准
    ...
    // 2.2pop中心点往下移
    inViewCenterPointInWidow.y += self.popView.height * 0.5 + inView.height * 0.5;
    ...
    if (position == CZPopViewPositionBottomLeft) {//左边
        ...
        //调整中心点x
        inViewCenterPointInWidow.x += (self.popView.width - inView.width) * 0.5;
        ...
        //这个方法好像有问题
        inViewCenterPointInWidow = CGPointMake(SCREEN_W / 2,  SCREEN_H - self.popView.height/2);
    }
    
    self.popView.center = inViewCenterPointInWidow;
