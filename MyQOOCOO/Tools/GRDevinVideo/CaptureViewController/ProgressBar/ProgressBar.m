...
#define INDICATOR_W 1
#define INDICATOR_H 5
...
- (void)initalize
{
    ...
    //最短分割线
    UIView *intervalView = [[UIView alloc] initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width/6, 0, 1, BAR_H)];
    intervalView.backgroundColor = BAR_BLUE_COLOR;
